...
public class lexerDart extends Lexer {
	...
	public static final int
		...
		NUMBER=202, SINGLEQUOTATION=203, DOUBLEQUOTATION=204, NAME=205, STRING=206, 
		StringDQ=207, IDENTIFIER=208, TAG_WHITESPACE=209;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"RUNAPP", "DOLAR", "AND", "COMMA", "OB", "CB", "OBC", "CBC", "OP", "CP", 
			"COLON", "DOT", "EQUAL", "EG", "ASSIGN", "GT", "LT", "LTE", "MINUS_EQUAL", 
			...
			"IS_NOT_EMPTY", "CLEAR", "REMOVE_AT", "MAIN", "NUMBER", "EXPONENT", "LETTER", 
			"DIGIT", "SINGLEQUOTATION", "DOUBLEQUOTATION", "NAME", "NAMEChar", "NAMEStartChar", 
			"STRING", "StringDQ", "StringSQ", "StringContentSQ", "IDENTIFIER_START", 
			"IDENTIFIER_PART", "StringContentDQ", "IDENTIFIER", "TAG_WHITESPACE"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DOUBLEQUOTATION", "NAME", "STRING", "StringDQ", "IDENTIFIER", "TAG_WHITESPACE"
		};
	}
	...
	public lexerDart(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "lexerDart.g4"; }
